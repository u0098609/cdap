 ...
 * The router logic guarantees that the same forwarding connection won't have more than request on the fly
 * (i.e. no HTTP pipeline), hence it's safe to use fields to remember the {@link AuditLogEntry} in field
