...
public class RemoteExecutionTwillController implements TwillController {
  ...
  public Future<Map<String, LogEntry.Level>> updateLogLevels(Map<String, LogEntry.Level> logLevels) {
    // TODO: Use runtime monitor to change
  ...
  public Future<Command> sendCommand(Command command) {
    // TODO: Use runtime monitor to send command
  ...
  @Override
  public void kill() {
    // TODO: Runtime monitor should have a kill call
    runtimeMonitor.stop();
  }
  ...
  public TerminationStatus getTerminationStatus() {
    ...
    // TODO: The actual state needs to be coming from the runtime monitor
    try {
      awaitTerminated();
